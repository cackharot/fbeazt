...
class PaymentSuccessView(View):
    ...
    def dispatch_request(self):
        ...
        if payment_details is None:
            ...
            self.log.warn("Reattempt of online payment [%s] status: %s, payid: %s, pg_type: %s" %
                          (txnid, payment_details['status'], payment_details['payuMoneyId'], payment_details['pg_type']))
